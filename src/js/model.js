import { API_URL, RES_PER_PAGE, APIKEY } from './config.js';
...
export const updateServings = function (toIncrease) {
  ...
  toIncrease ? state.recipe.servings++ : state.recipe.servings--;
};
